...
export async function synthesizePropVector(spec, customConfig) {
    const systemPrompt = `
...
export async function synthesizeCaricatureVector(spec, customConfig) {
    const systemPrompt = `
...
export async function synthesizeBackgroundVector(spec, customConfig) {
    const systemPrompt = `
