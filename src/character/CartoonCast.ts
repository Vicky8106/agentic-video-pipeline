...
export interface CharacterRenderOpts {
  ...
  rotation?: number;
  timeSec?: number;
  expression?: "neutral" | "shock" | "happy" | "deadpan" | "panic" | "smug";
  blink?: boolean;
}

// Helper for dynamic breathing & bobbing
export function getBob(timeSec: number = 0, speed: number = 4, amp: number = 6): number {
 ...
 */
export function renderJennaOrtega(opts: CharacterRenderOpts): string {
 ...
 */
export function renderEmmaStone(opts: CharacterRenderOpts): string {
 ...
 */
export function renderArianaGrande(opts: CharacterRenderOpts): string {
  const { x, y, scale = 1, rotation = 0, timeSec = 0 } = opts;
 ...
 */
export function renderKateMoss(opts: CharacterRenderOpts): string {
  const { x, y, scale = 1, rotation = 0, timeSec = 0 } = opts;
 ...
 */
export function renderTechBro(opts: CharacterRenderOpts & { mode?: "crypto" | "ai"; poof?: boolean }): string {
 ...
 */
export function renderPaparazzi(x: number, y: number, isFlashing: boolean = false): string {
  return `
 ...
 * 7. Couch Guy
 */
export function renderCouchGuy(opts: { x: number; y: number; scale?: number; isDucking?: boolean; timeSec?: number }): string {
 ...
 */
export function renderPixarMom(opts: CharacterRenderOpts & { showOrbit?: boolean }): string {
 ...
 */
export function renderEvictedOrgans(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderFlyingCarbs(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderMegaStamp(x: number, y: number, progress: number = 1): string {
 ...
 */
export function renderBossShadow(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderSeductiveBread(x: number, y: number, timeSec: number = 0, isBlocked: boolean = false): string {
 ...
 */
export function renderMaryPoppinsWind(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderCouchPennyHunter(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderFirehoseWater(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderSupermarketHam(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderPumpkinSurgeon(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderVictorianMourner(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderWednesdayDance(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderZapruderProjector(x: number, y: number, timeSec: number = 0): string {
 ...
 */
export function renderGoldWheelbarrow(x: number, y: number, timeSec: number = 0): string {
  return `
 ...
 */
export function renderTuxedoButler(x: number, y: number, timeSec: number = 0): string {
