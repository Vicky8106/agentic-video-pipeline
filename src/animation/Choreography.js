export function action(type, start, end, payload = {}, actor, target) {
    return {
...
export function sequenceBeat(beat) {
 ...
 */
export function comedyReveal(start, end, actor = "host", target) {
...
export function anticipationImpactReaction(start, end, actor = "host", target) {
    return comedyReveal(start, end, actor, target);
}
/** Split a beat into explicit performance bits. */
export function bitWindows(start, end, count) {
