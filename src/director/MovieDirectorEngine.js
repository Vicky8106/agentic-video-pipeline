...
import { getActiveBeat, MOVIE_BEATS } from "./ShotTimeline";
export function activeBeatIn(beats, timeSec) {
    if (timeSec < beats[0].startSec)
        return beats[0];
...
export function renderDirectedMovieFrame(timeSec, beats = MOVIE_BEATS) {
    ...
    let bg = renderBackground(beat.bgId, { timeSec });
    ...
    const actorState = {
        ...
        hairStyle: beat.actor.hairStyle,
        clothes: beat.actor.clothes,
