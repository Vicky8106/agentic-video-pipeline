 ...
 */
export function renderHand(params) {
    const { x, y, angleDeg, pose = "relaxed_mitt", isLeft = false, scale = 1.0, strokeColor = "#111111", fillColor = "#fed89b", // Matching Casually Explained warm peach skin
    strokeWidth = 5, } = params;
 ...
 */
export function renderGrippingHandLayers(params) {
    const { x, y, angleDeg, isLeft = false, scale = 1.0, strokeColor = "#111111", fillColor = "#fed89b", strokeWidth = 5, } = params;
    const flipX = isLeft ? -1 : 1;
    const backSvg = `
